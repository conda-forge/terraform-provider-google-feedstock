About terraform-provider-google-feedstock
=========================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/terraform-provider-google-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/terraform-provider-google-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add terraform-provider-google
# for installing globally
pixi global install terraform-provider-google
```
...
It is possible to list all of the versions of `terraform-provider-google` available on your platform:
...
```
pixi search terraform-provider-google --channel conda-forge
```
