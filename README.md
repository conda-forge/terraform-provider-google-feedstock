...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/terraform-provider-google-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/terraform-provider-google-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/terraform-provider-google-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/terraform-provider-google-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/terraform-provider-google-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/terraform-provider-google-feedstock/branch/master)
